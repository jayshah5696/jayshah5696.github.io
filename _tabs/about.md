...
![Profile Image](/assets/images/Profile.jpg){: width="200" style="border-radius: 50%; display: block; margin: 0 auto;"}
...
- [Pravāha: AI-Powered Search Engine](https://github.com/jayshah5696/pravah) - LLM enhanced search relevance with specialized ranking/chunking
- [StreamLens](https://github.com/rohrao/llamaindex_RAGathon) - Winner at Rag-a-thon 2024, multi-model RAG system for AV streams
- [Gujarati Llama](https://huggingface.co/jayshah5696/Gujarati-Llama-7b-Base) - Fine-tuned Llama-2 with 60k bilingual pairs
- [NeuroBuddy](https://devpost.com/software/neurobuddy) - Personalized chatbot for mental health support
- [Predicting Drowsiness Related Lane Departures](https://jayshah5696.github.io/drowsy_driving/) - Published research on drowsiness-induced lane departures
- [Power Curve Estimation for Wind Energy Farms](https://github.com/jayshah5696/Power_Curve_Estimation)
- [Customer Relationship Prediction](https://github.com/jayshah5696/Crm-Analytics) - Customer churn, appetency, and up-selling prediction
- [Phase 1 Analysis of Multivariate Quality Control Data](https://github.com/jayshah5696/Phase1_Analysis) - Industrial forging process analysis
